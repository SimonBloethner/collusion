...
class Agent(Agent):
    def __init__(self, unique_id, model, steps, input_dims, alpha=0.0003, beta=0.0003, gamma=0.99, n_actions=1, max_size=1000000,
    ...
    def choose_action(self, observation):
        ...
        self.action = actions.cpu().detach().numpy()[0]
        return self.action
